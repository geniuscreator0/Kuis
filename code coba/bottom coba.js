...
function download(e){var t=$("<a style='display:none' id='js-downloder'>").attr("href",e).attr("download","exam.png").appendTo("body");t[0].click(),t.remove()}function saveCapture(e){html2canvas(e).then(function(e){download(e.toDataURL("image/png"))})